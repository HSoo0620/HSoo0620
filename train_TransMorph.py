...
# filename = "./BTCV_Data/0830_affine_1_exis_stack.nii.gz"
...
def main():
    batch_size = 1
    # train_dir = './OASIS_L2R_2021_task03/All/'
    # val_dir = './OASIS_L2R_2021_task03/Test/'
    train_dir = './0927_Transmorph/All/'
    val_dir = './0927_Transmorph/Test/'
    ...
    train_set = datasets.OASISBrainDataset(glob.glob(train_dir + '*.nii.gz'), transforms=train_composed)
    val_set = datasets.OASISBrainInferDataset(glob.glob(val_dir + '*.nii.gz'), transforms=val_composed)
    ...
    for epoch in range(epoch_start, max_epoch):
        ...
        for data in train_loader:
            ...
            y_seg_oh = nn.functional.one_hot(y_seg.long(), num_classes=14)
...
def mk_grid_img(grid_step, line_thickness=1, grid_sz=(128,128,64)):
